...
![UEL as a Prot&eacute;g&eacute; plug-in](https://github.com/julianmendez/uel/blob/master/docs/img/02_protege.png)
...
![open an ontology using UEL](https://github.com/julianmendez/uel/blob/master/docs/img/03_open_ontology.png)
...
![start the unification algorithm](https://github.com/julianmendez/uel/blob/master/docs/img/07_start_unification.png)
...
![save the current unifier to an ontology file](https://github.com/julianmendez/uel/blob/master/docs/img/09_save_unifier.png)
